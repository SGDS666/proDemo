          ...
          <div>
            ...
            {state.tabKey === 'searchMonth' ? (
              <div style={{ color: '#b57d1d' }}>
                {numeral(price / 100 / count).format('0,0.000')} 元/点
              </div>
            ) : (
              <div style={{ color: '#b57d1d' }}>
                {numeral(price / 100 / count / 12).format('0,0.000')} 元/点
              </div>
            )}
          </div>
        </Radio.Button>
  ...
  const getModalContent = () => {
    return (
      <>
        {state.tabKey === 'searchMonth' ? (
          <div style={style1}>
            购买 <span style={{ color: '#e9b966', fontWeight: 700 }}>月</span> 套餐:
          </div>
        ) : (
          <div style={style1}>
            购买 <span style={{ color: '#ff7b64', fontWeight: 700 }}>年</span> 套餐:
          </div>
        )}
        <div>
          ...
          items={[
            {
              ...
              label: (
                <div style={{ width: 336, fontSize: 20, textAlign: 'center', fontWeight: 700 }}>
                  <img width={24} src="https://files.laifaxin.com/www/svip.jpg" /> 获客月套餐
                </div>
              ),
            ...
            },
            {
              ...
              label: (
                <div style={{ width: 336, fontSize: 20, textAlign: 'center', fontWeight: 700 }}>
                  <img width={24} src="https://files.laifaxin.com/www/vip.jpg" /> 获客年套餐
                </div>
              ),
              children: getModalContent()
            }
