...
import { Space, Button, Tag, Menu, theme } from 'antd';
...
const Packages: React.FC = () => {
  ...
  return (
    <RightContainer pageTitle={false} pageGroup="expenses" pageActive="packages">
      <div className={styles.main} style={{ overflow: "hidden" }}>
        <div className={`${styles.leftMenu} both-right`} style={{ borderColor: token.colorBorderBg }}>
          <Menu
            mode="inline"
