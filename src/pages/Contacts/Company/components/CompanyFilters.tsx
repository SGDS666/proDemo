...
const FieldsData = [
  ...
  { dataIndex: 'orgName', title: '企业名称', valueType: 'text' },
  { dataIndex: 'website', title: '官网', valueType: 'text' },
  { dataIndex: 'countryCode', title: '国家或地区', valueType: 'select', items: CountriesData },
  { dataIndex: 'industry', title: '行业', valueType: 'text' },
  { dataIndex: 'short_description', title: '公司简介', valueType: 'text' },
  { dataIndex: 'keywords', title: '公司关键词', valueType: 'text' },
  { dataIndex: 'technologies', title: '相关技术', valueType: 'text' },
  { dataIndex: 'revenue', title: '营业额', valueType: 'digit' },
  { dataIndex: 'employees', title: '员工数量', valueType: 'digit' },
...
const CompanyFilters: React.FC<Props> = (props) => {
  const { filters, visible, onCancel, onApplyAction, viewConfig, logic, onLogicChange } = props;
  ...
  return (
    <>
      <Drawer title={renderTitle()} open={visible} onClose={onCancel} mask={false}>
