...
import TaskCompany from './components/TaskCompany';
...
const TaskCompanyViews: React.FC<FormProps> = (props) => {
  ...
  return state.showAllViews ? (
    <ViewsList onClose={() => setState({ showAllViews: false })} viewType="searchCompany" />
  ) : (
    <Card title={false}>
      <Tabs
...
export default TaskCompanyViews;
