...
const FieldsData = [
  ...
  { dataIndex: 'industries', title: '行业', valueType: 'text' },
  { dataIndex: 'type', title: '类型', valueType: 'text' },
  { dataIndex: 'specialties', title: '主营', valueType: 'text' },
...
const OrganizationFilter: React.FC<Props> = (props) => {
