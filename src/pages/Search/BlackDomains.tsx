...
import { Button, Card, Checkbox, DatePicker, Input, message, Modal, Space, Table } from 'antd';
...
const BlackDomains: React.FC = () => {
  ...
  return (
    <RightContainer pageTitle={false} pageGroup="search" pageActive="black-domains">
      <ProCard
        split="vertical"
        bordered
        headerBordered
      ...
      >
        ...
        <ProCard title={false}
          bodyStyle={{ background: "none" }}
          style={{ background: "none" }}>
          <div className='both-down' style={{ animationDelay: "0.1s" }} >
            <Input.TextArea
          ...
          <div style={{ marginTop: 24, marginBottom: 24, animationDelay: "0.1s" }} className="both-up" >
